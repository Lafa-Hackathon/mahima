								...
								<tbody>
									@foreach($expiring_assets as $asset)
										<tr>
											...
											<td>@if(empty($asset->max_end_date)) <span class="label bg-red">@lang('report.expired')</span> @else
												@if(\Carbon\Carbon::parse($asset->max_end_date)->lessThan(\Carbon\Carbon::today()))
													<span class="label bg-red">@lang('report.expired'): {{@format_date($asset->max_end_date)}}</span>
												@else
													<span class="label bg-yellow">@lang('assetmanagement::lang.expiring_on'): {{@format_date($asset->max_end_date)}}</span>
												@endif
											@endif</td>
										</tr>
									@endforeach
